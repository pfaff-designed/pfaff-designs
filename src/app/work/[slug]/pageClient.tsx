...
import type { CaseStudyPage as CaseStudyData } from "@/lib/caseStudies/types";
...
export function CaseStudyPageClient({ slug, caseStudy, projectMeta, tools }: Props) {
  // Defensive: if case study missing in client hydration, bail.
  if (!caseStudy) {
    notFound();
  }
        ...
        <>
          ...
          <div className="">
            {caseStudy.sections.map((section, index) => {
              ...
              const shouldUseSectionImage =
                (sectionVariant === "2-column-image-right" ||
                  sectionVariant === "2-column-image-left" ||
